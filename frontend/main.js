Moralis.initialize("7QsuLJHDjZFYVJ8BkJSpHpOsmJY5NRy1FKrF20Si");
Moralis.serverURL = 'https://62gm6dfqcvzl.bigmoralis.com:2053/server'
const TOKEN_CONTRACT_ADDRESS = "0x94757e27811E5b20E217Af8D0cd33792A453Cdd7";
const MARKETPLACE_CONTRACT_ADDRESS = "0x966757e72A00AF7e2e1d039f8256FBDBCB4dD19b";
...
renderItem = (item) => {
    ...
    itemForSale.getElementsByTagName("p")[1].innerText = `NFT ID: ${item.tokenId}`;
    itemForSale.getElementsByTagName("p")[3].innerText = item.ownerOf;
    itemForSale.getElementsByTagName("p")[5].innerText = item.tokenAddress;


    itemForSale.getElementsByTagName("button")[0].innerText = `Adopt for ${item.askingPrice} wei`;
